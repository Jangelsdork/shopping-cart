//Map an array of items into a factory function that updates state of items. End result = "items" array of objects

const itemFactory = (colorId, itemName, itemDescription, itemPrice, itemId) => {
...
const somethingAwful = itemFactory("#E6C940", "Something Awful", "Looking for a color that screams \"I'm the shade of a banana that's been left in the sun for too long\"? Well, look no further than #E6C940 - the perfect choice for when you want to add a touch of questionable ripeness to your design palette!", '600', 5)
